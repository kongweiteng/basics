...
public class GenerateTool {
    ...
    public EnergyResp<String> generate(@RequestBody GenerateReq generateReq,HttpServletRequest request) {
        ...
        gc.setOutputDir(generateReq.getAdders() + "/energy-provider-business/src/main/java");
        ...
        pc.setParent("com.enn.energy.business");
        ...
        */
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return generateReq.getAdders() + "/energy-provider-business/src/main/resources/mybatis/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
