package com.enn.web.common.exception;
...
@ControllerAdvice
@Slf4j
public class EnergyWebException {
    ...
    public EnergyResp<String> etspExceptionHandler(EnergyException e) {
        ...
        error += "Class：" + stackTraceElement.getFileName() + ", Method：" + stackTraceElement.getMethodName() + ", Line：" + stackTraceElement.getLineNumber() + ", error：" + e.getMessage()+", time："+ DateUtil.format(time,"yyyy-MM-dd HH:mm:ss");
        ...
        sysLogError.setProject("energy-consumer-web");
