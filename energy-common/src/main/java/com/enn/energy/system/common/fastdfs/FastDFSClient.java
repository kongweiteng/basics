package com.enn.energy.system.common.fastdfs;

import com.enn.energy.system.common.fastdfs.common.NameValuePair;
import com.enn.energy.system.common.fastdfs.util.*;
...
public class FastDFSClient {
    ...
    public static String saveFile(MultipartFile multipartFile) throws IOException {
        ...
        try {
            fileAbsolutePath = FastDFSClient.upload(file);  //上传文件
        } catch (Exception e) {
